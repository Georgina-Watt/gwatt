...
function luviana_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_setting('luviana_sticky_menu', array(
        'default' => false,
        'sanitize_callback' => 'luviana_sanitize_checkbox'
    ));
    $wp_customize->add_control('luviana_sticky_menu', array(
        'label' => __('Make menu sticky?', 'luviana'),
        'section' => 'luviana_header_options',
        'type' => 'checkbox',
        'priority' => 90
    ));

    $wp_customize->add_setting('luviana_sticky_menu_on_scroll', array(
        'default' => true,
        'sanitize_callback' => 'luviana_sanitize_checkbox'
    ));
    $wp_customize->add_control('luviana_sticky_menu_on_scroll', array(
        'label' => __('Enable slide-out/slide-in menu behaviour on scroll?', 'luviana'),
        'section' => 'luviana_header_options',
        'type' => 'checkbox',
        'description' => __('Works only with enabled sticky menu.', 'luviana'),
        'priority' => 91
    ));
	...
	$wp_customize->add_setting('luviana_back_to_top_button', array(
		'default' => false,
		'sanitize_callback' => 'luviana_sanitize_checkbox'
	));
	$wp_customize->add_control('luviana_back_to_top_button', array(
		'label' => __('Enable "back to top" button?', 'luviana'),
		'section' => 'luviana_global_options',
		'type' => 'checkbox',
	));
