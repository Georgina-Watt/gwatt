...
function luviana_scripts() {
	...
	wp_register_script('headroom', get_template_directory_uri() . '/assets/headroom/headroom.min.js', array(), '0.12.0', true);
...
if ( ! function_exists( 'luviana_theme_updater' ) ) :
	/**
	 * Theme Updater
	 ...
	 */
	function luviana_theme_updater() {
		if ( current_user_can( 'update_themes' ) ) {
			require get_template_directory() . '/inc/updater/theme-updater.php';
		}
	}
endif;
add_action( 'after_setup_theme', 'luviana_theme_updater' );
